  ...
  return (
    <>
      ...
      >
        ...
        <td style={{ ...styles.td, ...styles.summaryCell }}>
          {call.summary ? (
...
// Color-coded caller sentiment, generated by GPT at call end (see
// voice/recording-complete). Old calls from before this feature have no
// sentiment and show a muted dash instead.
function SentimentBadge({ sentiment }: { sentiment: string | null }) {
  if (!sentiment) return <Muted>—</Muted>;

  const colorMap: Record<string, { bg: string; fg: string }> = {
    positive: { bg: "#E8F0E9", fg: "#4B6651" },
    neutral: { bg: "#F2ECE1", fg: "#6B6358" },
    negative: { bg: "#FBEAE6", fg: "#A8392B" },
  };
